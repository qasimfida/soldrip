        ...
        <section id="features" className="pt-26 -mt-26" >
            <Container className="pt-16 pb-11 md:pb-27 md:pt-28" >
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    <input readOnly value={DRIP_TOKEN_ADDRESS} className="flex items-center justify-center h-12 max-w-full px-3 mt-2 text-sm font-medium text-center border rounded-lg border-primary/20 w-md bg-primary/10 md:h-13 text-secondary md:text-base" />
