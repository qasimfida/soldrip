...
const Insurance = () => {
    return (
        <section id="insurance" className="mb-16 md:mb-20 pt-26 -mt-26" >
            <div className="bg-card">
                <Container className="px-6 py-11 md:py-18" >
                    <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-base font-normal text-left text-white md:text-2xl">Other coins leave their faithful holding bags if the devs disappear. $DRIP bakes in "Rug Insurance"—the treasury wallet is always growing from fees and activity, so if disaster strikes, holders still get paid.</p>
                        ...
                        <div className="flex flex-col items-center gap-5 p-[30px] text-center md:px-10 border rounded-lg shadow-primary border-primary/20 bg-primary/10">
