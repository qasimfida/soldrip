    ...
    return (
        <svg width="1254" height="298" viewBox="0 0 1254 298" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} >
            <g filter="url(#filter0_d_3135_1220)">
                <path d="M1227 159.677C1171.34 194.623 1041.69 260.52 968.399 244.545C876.787 224.576 854.173 121.735 712.696 97.7726C571.22 73.8097 391.132 270.401 281.545 150.087C171.959 29.7739 174.275 -10.2566 27 6.71707" stroke="url(#paint0_linear_3135_1220)" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
                <filter id="filter0_d_3135_1220" x="0.499817" y="0.499756" width="1253" height="297" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <linearGradient id="paint0_linear_3135_1220" x1="1227" y1="125" x2="27" y2="125" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#988AF3" />
                    <stop offset="1" stopColor="#56C9C9" />
                </linearGradient>
            </defs>
        </svg>
